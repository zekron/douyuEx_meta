...
.container__NmNfZ .layout-Player-chat>* {
	bottom: 0 !important;
}.extool {
	background-color: rgba(255,255,255,0.9);
	width: 100%;
...
.layui-timeline-title {
    ...
    `,e.insertBefore(t,e.childNodes[0]))}function setBarrgePanelFunc(o,n){document.getElementById("barragePanel__reply").onclick=()=>{var e=o.getElementsByClassName("danmuContent-25f266")[0].innerText,t=document.getElementsByClassName("ChatSend-txt")[0],e=`@${n}：`+e;"TEXTAREA"==t.tagName?t.value=e:t.innerText=e},document.getElementById("barragePanel__mute").onclick=async()=>{var e=document.getElementById("barragePanel__muteSelect").value||"1",t=await addMuteUser(rid,n,e);"添加成功"==t.msg?showMessage(`【禁言】${n}已被禁言${e}分钟`,"success"):showMessage(t.msg,"error")},document.getElementById("barragePanel__search").onclick=async()=>{var e=await getUserUid(n);""!==e&&openPage(`https://www.doseeing.com/data/fan/${e}?type=chat&dt=0`,!0)}}function insertBarragePanel_SearchBarrage_Dom(e){var t=parseInt(e.style.marginLeft);let o="-237px";o=237<t?"-237px":"237px";t=document.createElement("div");t.className="barragePanel__funcPanel",t.style="margin-left:"+o,t.innerHTML=`
...
%cver `+curVersion,"color:rgb(255,121,35);font-size:20px;font-weight:bold;","color:red;font-size:16px;")}function initPkg_CopyRealLive(){initPkg_CopyRealLive_Dom(),initPkg_CopyRealLive_Func()}function initPkg_CopyRealLive_Dom(){CopyRealLive_insertIcon()}function CopyRealLive_insertIcon(){var e=document.createElement("div");e.className="Title-blockInline",e.id="copy-real-live",e.innerHTML='<div class="TitleShare"><div class="TitleShare-shareBox "><div class="Title-row-span is-right"><span class="Title-row-icon "><svg t="1585641756842" class="icon" viewBox="0 0 1237 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5646" width="16" height="16"><path d="M648.448 946.347l0.256-1.622-0.256 1.622z m84.31 13.354c-0.769 4.608-0.769 4.608-4.182 13.483-8.533 16.768-8.533 16.768-49.835 22.784-24.149-14.293-24.149-14.293-27.605-22.613-2.475-5.718-2.475-5.718-3.541-9.387L476.416 335.36l-103.083 499.2c-1.109 5.12-1.109 5.12-4.821 13.27-6.827 12.117-6.827 12.117-35.285 22.527-30.294-7.253-30.294-7.253-38.742-19.37-4.522-8.15-4.522-8.15-6.058-13.227l-74.582-262.357H0v-85.334h278.272l45.781 161.11 104.022-503.424c1.024-4.694 1.024-4.694 4.394-12.502 6.102-11.989 6.102-11.989 35.968-23.338 31.83 8.533 31.83 8.533 39.254 20.736 4.053 7.808 4.053 7.808 5.376 12.544l165.888 609.237 113.92-716.885c0.896-5.248 0.896-5.248 4.864-14.592 9.088-15.574 9.088-15.574 44.928-22.4C868.48 12.587 868.48 12.587 873.6 22.443c3.285 6.912 3.285 6.912 4.523 11.52l112 446.549h221.738v85.333H923.563l-78.507-312.917-112.299 706.773z" p-id="5647"></path></svg></span><span class="Title-row-text">复制直播流</span></div></div></div>';let t=document.getElementsByClassName("Title-col")[4];t&&1<t.childNodes.length?t.insertBefore(e,t.childNodes[1]):(t=getValidDom([".subTitleContainer__-vzhr"])).appendChild(e)}function CopyRealLive_getQn(e){return String(e).includes("蓝光8M")?8:String(e).includes("蓝光4M")?4:String(e).includes("超清")?3:String(e).includes("高清")?2:0}function CopyRealLive_copyUrl(e){getRealLive_Douyu(rid,!0,!1,e,e=>{"None"==e?showMessage("房间未开播或其他错误","error"):(e=String(e),GM_setClipboard(e),showMessage("复制成功","success"))})}function initPkg_CopyRealLive_Func(){document.getElementById("copy-real-live").addEventListener("click",function(){0<document.querySelectorAll(".tipItem-898596 > ul > li").length?document.querySelectorAll(".tipItem-898596 > ul > li").forEach(e=>{e.className.includes("selected")&&CopyRealLive_copyUrl(CopyRealLive_getQn(e.innerText))}):CopyRealLive_copyUrl(0)});var e=document.getElementsByClassName("RecommendViewTit-04ebd8");0<e.length&&e[0].innerText}const lastTime="Ex_DailyAuto_LastTime",restRid="12306";function initPkg_DailyAuto(){setTimeout(()=>{daily_main()},3e3)}function daily_main(){stateControl()&&(showMessage("【续牌】开始赠送荧光棒","info"),fansContinue_auto().then(()=>{localStorage.setItem(lastTime,new Date)}).catch(async e=>{0==e?showMessage("【续牌】赠送失败,背包为空","error"):-1==e&&showMessage("【续牌】赠送失败,没有荧光棒","error"),await(null!==await mscststs.wait(".BackpackButton",!0,timeout=50))?localStorage.setItem(lastTime,new Date):showMessage("【续牌】赠送失败,请进入直播间","warning",{timeout:100})}))}function stateControl(){var e,t=localStorage.getItem(lastTime);return!t||(t=new Date(t),e=new Date,e=e,(t=t).getFullYear()!==e.getFullYear())||t.getMonth()!==e.getMonth()||t.getDate()!==e.getDate()}function fansContinue_auto(){return new Promise((a,e)=>{let r=0;let s=0;getBagGifts("12306",t=>{var o=t.data.list.length;if(0<o){for(let e=0;e<o;e++){if(268==t.data.list[e].id){r=268,s=t.data.list[e].count;break}2358==t.data.list[e].id&&(r=2358,s=t.data.list[e].count)}0==r?(showMessage("没有足够的道具","error"),e(-1)):fetch("https://www.douyu.com/member/cp/getFansBadgeList",{method:"GET",mode:"no-cors",cache:"default",credentials:"include"}).then(e=>e.text()).then(async e=>{var t=(e=(new DOMParser).parseFromString(e,"text/html")).getElementsByClassName("fans-badge-list")[0].lastElementChild,o=t.children.length,n=(s=s-o<=0?0:s-o,[]);for(let e=0;e<o;e++){let o=t.children[e].getAttribute("data-fans-room");var i=new Promise((t,e)=>{sleep(100).then(()=>{sendGift_bag(r,Number(1),o).then(e=>{"success"==e.msg?(showMessage("【续牌】"+o+"赠送荧光棒成功","success"),t()):(showMessage("【续牌】"+o+"赠送失败 "+e.msg,"error"),console.log(o,e))}).catch(e=>{showMessage("【续牌】"+o+"赠送失败","error"),console.log(o,e)})})});n.push(i)}Promise.all(n).then(()=>{console.log("test-promise all"),sendGift_bag(r,Number(s),restRid).then(e=>{"success"==e.msg?(showMessage("【剩余全送】"+restRid+"赠送荧光棒成功","warning",{timeout:100}),a()):showMessage("【剩余全送】"+restRid+"赠送失败 "+e.msg,"error")}).catch(e=>{showMessage("【剩余全送】"+restRid+"赠送失败","error")})})}).catch(e=>{console.log("请求失败!",e)})}else e(0)})})}function initPkg_DanmakuCollect(){initPkg_DanmakuCollect_Dom();const t=document.getElementsByClassName("ChatSend-txt")[0],o=document.getElementsByClassName("ChatBarrageCollect")[0];t.addEventListener("keyup",()=>{var e=("string"==typeof t.value?t.value:t.innerText).length;o.style.display=25<e?"none":""}),document.getElementsByClassName("ChatSend-button")[0].addEventListener("click",()=>{o.style.display=""}),responseHook((e,t)=>{if(e.includes("bulletscreen/query"))return(e=JSON.parse(t)).data.list.unshift(...getLocalDanmakuCollect().map(e=>({content:e.content,type:2,id:e.id}))),JSON.stringify(e)}),responseHook((e,t,o)=>{if(e.includes("bulletscreen/add"))return 0==(e=JSON.parse(t)).error?t:(t=JSON.parse(o)["content"],addLocalDanmakuCollect(t),e.msg="收藏成功，云收藏已达上限，将收藏至本地（由DouyuEx插件实现无限收藏）",document.querySelector(".ChatBarrageCollect-tip").click(),document.querySelector(".ChatBarrageCollect-tip").click(),JSON.stringify(e))}),responseHook((e,t,o)=>{e.includes("bulletscreen/del")&&(e=JSON.parse(o)["id"],delLocalDanmakuCollect(e))})}function initPkg_DanmakuCollect_Dom(){let e=setInterval(()=>{void 0!==document.getElementsByClassName("ChatBarrageCollect")[0]&&(clearInterval(e),new DomHook(".ChatBarrageCollect",!1,e=>{var t,o=document.getElementsByClassName("ChatBarrageCollectPop-title");o?0!==o.length&&((t=document.createElement("input")).id="ex-danmaku-collect-search",t.placeholder="搜索弹幕",t.style.marginLeft="6px",o[0].appendChild(t),t.addEventListener("input",searchCollectDanmaku)):document.getElementById("ex-danmaku-collect-search").removeEventListener("input",searchCollectDanmaku)}))},1e3)}function searchCollectDanmaku(e){var t=e.target.value,o=document.getElementsByClassName("ChatBarrageCollectPop-barrageContent")[0].parentElement.getElementsByClassName("TagItem");for(let e=0;e<o.length;e++){var n=o[e];n.innerText.includes(t)?n.style.display="":n.style.display="none"}}function getLocalDanmakuCollect(){let t=localStorage.getItem("ExSave_DanmakuCollect");try{t=JSON.parse(t)||[]}catch(e){t=[]}return t}function addLocalDanmakuCollect(e){var t=getLocalDanmakuCollect();t.unshift({content:e,id:(new Date).getTime()}),localStorage.setItem("ExSave_DanmakuCollect",JSON.stringify(t))}function delLocalDanmakuCollect(t){var e=getLocalDanmakuCollect();localStorage.setItem("ExSave_DanmakuCollect",JSON.stringify(e.filter(e=>e.id!==t)))}function initPkg_DanmakuTail(){initPkg_DanmakuTail_insertDom(),initPkg_DanmakuTail_Set(),initPkg_DanmakuTail_Func()}function initPkg_DanmakuTail_insertDom(){var e=document.createElement("div");e.className="ChatToolBar-DanmakuTail",e.innerHTML='<div class="ChatToolBar-DanmakuTail-tip" title="弹幕小尾巴" ></div>';document.getElementsByClassName("ChatToolBar__left")[0].appendChild(e);var e=document.createElement("div"),t=(e.className="ChatToolBar-DanmakuTail-Panel",document.getElementsByClassName("layout-Player-chat")[0]);t.insertBefore(e,t.childNodes[0]),window.location.href.includes("/beta")||(e.style.bottom="120px"),e.innerHTML=`
    ...
    `}function initPkg_DanmakuTail_Set(){var e=localStorage.getItem("ExSave_DanmakuTail");null!=e&&(e=JSON.parse(e),document.getElementById("DanmakuTail-checkbox").checked=e.isTailEnabled,document.getElementById("DanmakuTail-input").value=e.tailContent||"",document.getElementById("DanmakuTail-input").disabled=e.isTailEnabled,e.isTailEnabled)&&document.querySelector(".ChatToolBar-DanmakuTail-tip").classList.add("ChatToolBar-DanmakuTail-tip-active")}function saveData_DanmakuTail(){var e={isTailEnabled:document.getElementById("DanmakuTail-checkbox").checked,tailContent:document.getElementById("DanmakuTail-input").value};localStorage.setItem("ExSave_DanmakuTail",JSON.stringify(e))}function initPkg_DanmakuTail_Func(){document.getElementsByClassName("ChatToolBar-DanmakuTail")[0].addEventListener("click",function(){showExRightPanel("弹幕小尾巴")}),initPkg_DanmakuTail_HandleFunc("#DanmakuTail-checkbox","#DanmakuTail-input"),document.getElementById("DanmakuTail-checkbox").addEventListener("change",function(){saveData_DanmakuTail()}),document.getElementById("DanmakuTail-input").addEventListener("input",function(){saveData_DanmakuTail()})}function initPkg_DanmakuTail_HandleFunc(e,t){let a=null,r=null;function o(o){if(window.location.href.includes("/beta")){let t=document.querySelector("div.ChatSend-txt");const n=document.querySelector(".ChatSend-button");t&&n&&(s(),a=function(e){!e.isTrusted||"Enter"!==e.key||e.shiftKey||(e.preventDefault(),e.stopPropagation(),n.click())},r=function(e){""!=t.innerText.trim()&&(t.innerText=t.innerText+o,t.dispatchEvent(new Event("input",{bubbles:!0})))},t.addEventListener("keydown",a,!0),n.addEventListener("click",r,!0))}else{let t=document.querySelector("textarea.ChatSend-txt");const i=document.querySelector(".ChatSend-button");t&&i&&(s(),a=function(e){!e.isTrusted||"Enter"!==e.key||e.shiftKey||(e.preventDefault(),e.stopPropagation(),i.click())},r=function(e){""!=t.value.trim()&&(t.value=t.value+o,t.dispatchEvent(new Event("input",{bubbles:!0})))},t.addEventListener("keydown",a,!0),i.addEventListener("click",r,!0))}}function s(){var e=document.querySelector("textarea.ChatSend-txt"),t=document.querySelector(".ChatSend-button");e&&a&&e.removeEventListener("keydown",a,!0),t&&r&&t.removeEventListener("click",r,!0),a=null,r=null}const n=document.querySelector(e),i=document.querySelector(t);return n&&(n.addEventListener("change",function(){""===i.value.trim()?(n.checked=!1,showMessage("【弹幕小尾巴】请输入弹幕小尾巴内容","error")):(i.disabled=n.checked,document.querySelector(".ChatToolBar-DanmakuTail-tip").classList.remove("ChatToolBar-DanmakuTail-tip-active"),s(),n.checked&&i&&(document.querySelector(".ChatToolBar-DanmakuTail-tip").classList.add("ChatToolBar-DanmakuTail-tip-active"),o(i.value.trim())))}),n.checked)&&i&&o(i.value.trim()),{enable:o,disable:s}}function initPkg_autoDark_hook(){var e=matchMedia("(prefers-color-scheme: dark)");const t=e=>{1===currentMode!=e&&document.getElementById("ex-night").click()};t(e.matches),e.addEventListener("change",e=>{t(e.matches)})}function autoDark_fast(){currentMode=matchMedia("(prefers-color-scheme: dark)").matches?1:0,saveData_Mode()}function initPkg_DisableCloseJump_Timer(){setInterval(()=>{var e=document.getElementsByClassName("dy-ModalRadius-close-x");0<e.length&&e[0].click()},1e3)}let dyVideoBarrage_domhook_videoChange=null,dyVideoBarrage_hasRendered=!1;const dyVideoBarrage_domName="ex-barrageLine",dyVideoBarrage_switchDomName="ex-barrageLine-switch";function initPkg_DyVideoBarrageLine(){let n=setInterval(()=>{var e=document.getElementsByTagName("demand-video")[0].shadowRoot.getElementById("demandcontroller-bar").shadowRoot.querySelector("demand-video-controller-progress").shadowRoot.querySelector(".ProgressBar-Safearea"),t=document.getElementsByTagName("demand-video-toolbar")[0].shadowRoot,o=document.getElementsByTagName("demand-video-toolbar")[0].shadowRoot;e&&t&&o&&(clearInterval(n),initPkg_DyVideoBarrageLine_Dom(),renderVideoBarrageLine(),e=o.querySelector("share-hover"),(dyVideoBarrage_domhook_videoChange=new MutationObserver(function(e){renderVideoBarrageLine()})).observe(e,{attributes:!0,childList:!0,subtree:!1}))},1e3)}function initPkg_DyVideoBarrageLine_Dom(){var e=document.createElement("style");e.innerHTML=`.no-hasLR #ex-barrageLine {
        display: none !important;
